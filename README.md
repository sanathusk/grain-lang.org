...
This documentation site is a [Astro](https://astro.build/) site. All of the docs are generated from Markdown files, and Astro builds a static website that is hosted on Netlify.
